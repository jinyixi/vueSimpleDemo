<template>
    ...
    <el-form ref="searchForm" :inline="true" :model="searchMap" style="margin-top: 20px">
        ...
        <el-form-item prop="member_card">
          ...
          <el-input v-model="searchMap.member_card" placeholder="员工工号" style="width: 200px"></el-input>
        </el-form-item>
        <!-- prop重置用 -->
        <el-form-item prop="member_name">
          <el-input v-model="searchMap.member_name" placeholder="员工姓名" style="width: 200px"></el-input>
        </el-form-item>
